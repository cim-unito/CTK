...
//-----------------------------------------------------------------------------
int ctkExampleUseOfWorkflowWidgetUsingThreads ( int argc, char * argv [] )
{
  ...
  ctkWorkflowStepWithThreadWidget* testStep1 = new ctkWorkflowStepWithThreadWidget("Step 1");
  ...
  ctkWorkflowStepWithThreadWidget* testStep2 = new ctkWorkflowStepWithThreadWidget("Step 2");
  ...
  ctkWorkflowStepWithThreadWidget* testStep3 = new ctkWorkflowStepWithThreadWidget("Step 3");
